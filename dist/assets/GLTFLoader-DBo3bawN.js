 ...
 * Subject to the terms at https://gsap.com/standard-license
 * @author: Jack Doyle, jack@greensock.com
*/var Cf,vr,js,zh,Zr,Pf,Vh,Dg=function(){return typeof window<"u"},sr={},Wr=180/Math.PI,$s=Math.PI/180,xs=Math.atan2,If=1e8,Hh=/([A-Z])/g,Lg=/(left|right|width|margin|padding|x)/i,Ug=/[\s,\(]\S/,Ii={autoAlpha:"opacity,visibility",scale:"scaleX,scaleY",alpha:"opacity"},Su=function(e,t){return t.set(t.t,t.p,Math.round((t.s+t.c*e)*1e4)/1e4+t.u,t)},Ng=function(e,t){return t.set(t.t,t.p,e===1?t.e:Math.round((t.s+t.c*e)*1e4)/1e4+t.u,t)},Fg=function(e,t){return t.set(t.t,t.p,e?Math.round((t.s+t.c*e)*1e4)/1e4+t.u:t.b,t)},Og=function(e,t){var n=t.s+t.c*e;t.set(t.t,t.p,~~(n+(n<0?-.5:.5))+t.u,t)},pm=function(e,t){return t.set(t.t,t.p,e?t.e:t.b,t)},mm=function(e,t){return t.set(t.t,t.p,e!==1?t.b:t.e,t)},Bg=function(e,t,n){return e.style[t]=n},kg=function(e,t,n){return e.style.setProperty(t,n)},zg=function(e,t,n){return e._gsap[t]=n},Vg=function(e,t,n){return e._gsap.scaleX=e._gsap.scaleY=n},Hg=function(e,t,n,i,r){var a=e._gsap;a.scaleX=a.scaleY=n,a.renderTransform(r,a)},Gg=function(e,t,n,i,r){var a=e._gsap;a[t]=n,a.renderTransform(r,a)},Dt="transform",Fn=Dt+"Origin",Wg=function s(e,t){var n=this,i=this.target,r=i.style,a=i._gsap;if(e in sr&&r){if(this.tfm=this.tfm||{},e!=="transform")e=Ii[e]||e,~e.indexOf(",")?e.split(",").forEach(function(o){return n.tfm[o]=$i(i,o)}):this.tfm[e]=a.x?a[e]:$i(i,e),e===Fn&&(this.tfm.zOrigin=a.zOrigin);else return Ii.transform.split(",").forEach(function(o){return s.call(n,o,t)});if(this.props.indexOf(Dt)>=0)return;a.svg&&(this.svgo=i.getAttribute("data-svg-origin"),this.props.push(Fn,t,"")),e=Dt}(r||t)&&this.props.push(e,t,r[e])},_m=function(e){e.translate&&(e.removeProperty("translate"),e.removeProperty("scale"),e.removeProperty("rotate"))},Xg=function(){var e=this.props,t=this.target,n=t.style,i=t._gsap,r,a;for(r=0;r<e.length;r+=3)e[r+1]?e[r+1]===2?t[e[r]](e[r+2]):t[e[r]]=e[r+2]:e[r+2]?n[e[r]]=e[r+2]:n.removeProperty(e[r].substr(0,2)==="--"?e[r]:e[r].replace(Hh,"-$1").toLowerCase());if(this.tfm){for(a in this.tfm)i[a]=this.tfm[a];i.svg&&(i.renderTransform(),t.setAttribute("data-svg-origin",this.svgo||"")),r=Vh(),(!r||!r.isStart)&&!n[Dt]&&(_m(n),i.zOrigin&&n[Fn]&&(n[Fn]+=" "+i.zOrigin+"px",i.zOrigin=0,i.renderTransform()),i.uncache=1)}},gm=function(e,t){var n={target:e,props:[],revert:Xg,save:Wg};return e._gsap||Bn.core.getCache(e),t&&e.style&&e.nodeType&&t.split(",").forEach(function(i){return n.save(i)}),n},xm,Mu=function(e,t){var n=vr.createElementNS?vr.createElementNS((t||"http://www.w3.org/1999/xhtml").replace(/^https/,"http"),e):vr.createElement(e);return n&&n.style?n:vr.createElement(e)},ui=function s(e,t,n){var i=getComputedStyle(e);return i[t]||i.getPropertyValue(t.replace(Hh,"-$1").toLowerCase())||i.getPropertyValue(t)||!n&&s(e,la(t)||t,1)||""},Df="O,Moz,ms,Ms,Webkit".split(","),la=function(e,t,n){var i=t||Zr,r=i.style,a=5;if(e in r&&!n)return e;for(e=e.charAt(0).toUpperCase()+e.substr(1);a--&&!(Df[a]+e in r););return a<0?null:(a===3?"ms":a>=0?Df[a]:"")+e},Tu=function(){Dg()&&window.document&&(Cf=window,vr=Cf.document,js=vr.documentElement,Zr=Mu("div")||{style:{}},Mu("div"),Dt=la(Dt),Fn=Dt+"Origin",Zr.style.cssText="border-width:0;line-height:0;position:absolute;padding:0",xm=!!la("perspective"),Vh=Bn.core.reverting,zh=1)},Lf=function(e){var t=e.ownerSVGElement,n=Mu("svg",t&&t.getAttribute("xmlns")||"http://www.w3.org/2000/svg"),i=e.cloneNode(!0),r;i.style.display="block",n.appendChild(i),js.appendChild(n);try{r=i.getBBox()}catch{}return n.removeChild(i),js.removeChild(n),r},Uf=function(e,t){for(var n=t.length;n--;)if(e.hasAttribute(t[n]))return e.getAttribute(t[n])},vm=function(e){var t,n;try{t=e.getBBox()}catch{t=Lf(e),n=1}return t&&(t.width||t.height)||n||(t=Lf(e)),t&&!t.width&&!t.x&&!t.y?{x:+Uf(e,["x","cx","x1"])||0,y:+Uf(e,["y","cy","y1"])||0,width:0,height:0}:t},ym=function(e){return!!(e.getCTM&&(!e.parentNode||e.ownerSVGElement)&&vm(e))},ls=function(e,t){if(t){var n=e.style,i;t in sr&&t!==Fn&&(t=Dt),n.removeProperty?(i=t.substr(0,2),(i==="ms"||t.substr(0,6)==="webkit")&&(t="-"+t),n.removeProperty(i==="--"?t:t.replace(Hh,"-$1").toLowerCase())):n.removeAttribute(t)}},yr=function(e,t,n,i,r,a){var o=new Nn(e._pt,t,n,0,1,a?mm:pm);return e._pt=o,o.b=i,o.e=r,e._props.push(n),o},Nf={deg:1,rad:1,turn:1},Yg={grid:1,flex:1},Pr=function s(e,t,n,i){var r=parseFloat(n)||0,a=(n+"").trim().substr((r+"").length)||"px",o=Zr.style,l=Lg.test(t),c=e.tagName.toLowerCase()==="svg",u=(c?"client":"offset")+(l?"Width":"Height"),h=100,f=i==="px",d=i==="%",_,g,p,m;if(i===a||!r||Nf[i]||Nf[a])return r;if(a!=="px"&&!f&&(r=s(e,t,n,"px")),m=e.getCTM&&ym(e),(d||a==="%")&&(sr[t]||~t.indexOf("adius")))return _=m?e.getBBox()[l?"width":"height"]:e[u],Ot(d?r/_*h:r/100*_);if(o[l?"width":"height"]=h+(f?a:i),g=i!=="rem"&&~t.indexOf("adius")||i==="em"&&e.appendChild&&!c?e:e.parentNode,m&&(g=(e.ownerSVGElement||{}).parentNode),(!g||g===vr||!g.appendChild)&&(g=vr.body),p=g._gsap,p&&d&&p.width&&l&&p.time===qn.time&&!p.uncache)return Ot(r/p.width*h);if(d&&(t==="height"||t==="width")){var S=e.style[t];e.style[t]=h+i,_=e[u],S?e.style[t]=S:ls(e,t)}else(d||a==="%")&&!Yg[ui(g,"display")]&&(o.position=ui(e,"position")),g===e&&(o.position="static"),g.appendChild(Zr),_=Zr[u],g.removeChild(Zr),o.position="absolute";return l&&d&&(p=ts(g),p.time=qn.time,p.width=g[u]),Ot(f?_*r/h:_&&r?h/_*r:0)},$i=function(e,t,n,i){var r;return zh||Tu(),t in Ii&&t!=="transform"&&(t=Ii[t],~t.indexOf(",")&&(t=t.split(",")[0])),sr[t]&&t!=="transform"?(r=_o(e,i),r=t!=="transformOrigin"?r[t]:r.svg?r.origin:Wl(ui(e,Fn))+" "+r.zOrigin+"px"):(r=e.style[t],(!r||r==="auto"||i||~(r+"").indexOf("calc("))&&(r=Gl[t]&&Gl[t](e,t,n)||ui(e,t)||Fp(e,t)||(t==="opacity"?1:0))),n&&!~(r+"").trim().indexOf(" ")?Pr(e,t,r,n)+n:r},qg=function(e,t,n,i){if(!n||n==="none"){var r=la(t,e,1),a=r&&ui(e,r,1);a&&a!==n?(t=r,n=a):t==="borderColor"&&(n=ui(e,"borderTopColor"))}var o=new Nn(this._pt,e.style,t,0,1,hm),l=0,c=0,u,h,f,d,_,g,p,m,S,M,x,w;if(o.b=n,o.e=i,n+="",i+="",i.substring(0,6)==="var(--"&&(i=ui(e,i.substring(4,i.indexOf(")")))),i==="auto"&&(g=e.style[t],e.style[t]=i,i=ui(e,t)||i,g?e.style[t]=g:ls(e,t)),u=[n,i],tm(u),n=u[0],i=u[1],f=n.match(Hs)||[],w=i.match(Hs)||[],w.length){for(;h=Hs.exec(i);)p=h[0],S=i.substring(l,h.index),_?_=(_+1)%5:(S.substr(-5)==="rgba("||S.substr(-5)==="hsla(")&&(_=1),p!==(g=f[c++]||"")&&(d=parseFloat(g)||0,x=g.substr((d+"").length),p.charAt(1)==="="&&(p=Ks(d,p)+x),m=parseFloat(p),M=p.substr((m+"").length),l=Hs.lastIndex-M.length,M||(M=M||Zn.units[t]||x,l===i.length&&(i+=M,o.e+=M)),x!==M&&(d=Pr(e,t,g,M)||0),o._pt={_next:o._pt,p:S||c===1?S:",",s:d,c:m-d,m:_&&_<4||t==="zIndex"?Math.round:0});o.c=l<i.length?i.substring(l,i.length):""}else o.r=t==="display"&&i==="none"?mm:pm;return Pp.test(i)&&(o.e=0),this._pt=o,o},Ff={top:"0%",bottom:"100%",left:"0%",right:"100%",center:"50%"},Kg=function(e){var t=e.split(" "),n=t[0],i=t[1]||"50%";return(n==="top"||n==="bottom"||i==="left"||i==="right")&&(e=n,n=i,i=e),t[0]=Ff[n]||n,t[1]=Ff[i]||i,t.join(" ")},jg=function(e,t){if(t.tween&&t.tween._time===t.tween._dur){var n=t.t,i=n.style,r=t.u,a=n._gsap,o,l,c;if(r==="all"||r===!0)i.cssText="",l=1;else for(r=r.split(","),c=r.length;--c>-1;)o=r[c],sr[o]&&(l=1,o=o==="transformOrigin"?Fn:Dt),ls(n,o);l&&(ls(n,Dt),a&&(a.svg&&n.removeAttribute("transform"),i.scale=i.rotate=i.translate="none",_o(n,1),a.uncache=1,_m(i)))}},Gl={clearProps:function(e,t,n,i,r){if(r.data!=="isFromStart"){var a=e._pt=new Nn(e._pt,t,n,0,0,jg);return a.u=i,a.pr=-10,a.tween=r,e._props.push(n),1}}},mo=[1,0,0,1,0,0],Sm={},Mm=function(e){return e==="matrix(1, 0, 0, 1, 0, 0)"||e==="none"||!e},Of=function(e){var t=ui(e,Dt);return Mm(t)?mo:t.substr(7).match(Cp).map(Ot)},Gh=function(e,t){var n=e._gsap||ts(e),i=e.style,r=Of(e),a,o,l,c;return n.svg&&e.getAttribute("transform")?(l=e.transform.baseVal.consolidate().matrix,r=[l.a,l.b,l.c,l.d,l.e,l.f],r.join(",")==="1,0,0,1,0,0"?mo:r):(r===mo&&!e.offsetParent&&e!==js&&!n.svg&&(l=i.display,i.display="block",a=e.parentNode,(!a||!e.offsetParent&&!e.getBoundingClientRect().width)&&(c=1,o=e.nextElementSibling,js.appendChild(e)),r=Of(e),l?i.display=l:ls(e,"display"),c&&(o?a.insertBefore(e,o):a?a.appendChild(e):js.removeChild(e))),t&&r.length>6?[r[0],r[1],r[4],r[5],r[12],r[13]]:r)},Eu=function(e,t,n,i,r,a){var o=e._gsap,l=r||Gh(e,!0),c=o.xOrigin||0,u=o.yOrigin||0,h=o.xOffset||0,f=o.yOffset||0,d=l[0],_=l[1],g=l[2],p=l[3],m=l[4],S=l[5],M=t.split(" "),x=parseFloat(M[0])||0,w=parseFloat(M[1])||0,A,b,C,y;n?l!==mo&&(b=d*p-_*g)&&(C=x*(p/b)+w*(-g/b)+(g*S-p*m)/b,y=x*(-_/b)+w*(d/b)-(d*S-_*m)/b,x=C,w=y):(A=vm(e),x=A.x+(~M[0].indexOf("%")?x/100*A.width:x),w=A.y+(~(M[1]||M[0]).indexOf("%")?w/100*A.height:w)),i||i!==!1&&o.smooth?(m=x-c,S=w-u,o.xOffset=h+(m*d+S*g)-m,o.yOffset=f+(m*_+S*p)-S):o.xOffset=o.yOffset=0,o.xOrigin=x,o.yOrigin=w,o.smooth=!!i,o.origin=t,o.originIsAbsolute=!!n,e.style[Fn]="0px 0px",a&&(yr(a,o,"xOrigin",c,x),yr(a,o,"yOrigin",u,w),yr(a,o,"xOffset",h,o.xOffset),yr(a,o,"yOffset",f,o.yOffset)),e.setAttribute("data-svg-origin",x+" "+w)},_o=function(e,t){var n=e._gsap||new sm(e);if("x"in n&&!t&&!n.uncache)return n;var i=e.style,r=n.scaleX<0,a="px",o="deg",l=getComputedStyle(e),c=ui(e,Fn)||"0",u,h,f,d,_,g,p,m,S,M,x,w,A,b,C,y,v,P,N,B,W,j,G,K,V,te,I,le,De,Je,q,ne;return u=h=f=g=p=m=S=M=x=0,d=_=1,n.svg=!!(e.getCTM&&ym(e)),l.translate&&((l.translate!=="none"||l.scale!=="none"||l.rotate!=="none")&&(i[Dt]=(l.translate!=="none"?"translate3d("+(l.translate+" 0 0").split(" ").slice(0,3).join(", ")+") ":"")+(l.rotate!=="none"?"rotate("+l.rotate+") ":"")+(l.scale!=="none"?"scale("+l.scale.split(" ").join(",")+") ":"")+(l[Dt]!=="none"?l[Dt]:"")),i.scale=i.rotate=i.translate="none"),b=Gh(e,n.svg),n.svg&&(n.uncache?(V=e.getBBox(),c=n.xOrigin-V.x+"px "+(n.yOrigin-V.y)+"px",K=""):K=!t&&e.getAttribute("data-svg-origin"),Eu(e,K||c,!!K||n.originIsAbsolute,n.smooth!==!1,b)),w=n.xOrigin||0,A=n.yOrigin||0,b!==mo&&(P=b[0],N=b[1],B=b[2],W=b[3],u=j=b[4],h=G=b[5],b.length===6?(d=Math.sqrt(P*P+N*N),_=Math.sqrt(W*W+B*B),g=P||N?xs(N,P)*Wr:0,S=B||W?xs(B,W)*Wr+g:0,S&&(_*=Math.abs(Math.cos(S*$s))),n.svg&&(u-=w-(w*P+A*B),h-=A-(w*N+A*W))):(ne=b[6],Je=b[7],I=b[8],le=b[9],De=b[10],q=b[11],u=b[12],h=b[13],f=b[14],C=xs(ne,De),p=C*Wr,C&&(y=Math.cos(-C),v=Math.sin(-C),K=j*y+I*v,V=G*y+le*v,te=ne*y+De*v,I=j*-v+I*y,le=G*-v+le*y,De=ne*-v+De*y,q=Je*-v+q*y,j=K,G=V,ne=te),C=xs(-B,De),m=C*Wr,C&&(y=Math.cos(-C),v=Math.sin(-C),K=P*y-I*v,V=N*y-le*v,te=B*y-De*v,q=W*v+q*y,P=K,N=V,B=te),C=xs(N,P),g=C*Wr,C&&(y=Math.cos(C),v=Math.sin(C),K=P*y+N*v,V=j*y+G*v,N=N*y-P*v,G=G*y-j*v,P=K,j=V),p&&Math.abs(p)+Math.abs(g)>359.9&&(p=g=0,m=180-m),d=Ot(Math.sqrt(P*P+N*N+B*B)),_=Ot(Math.sqrt(G*G+ne*ne)),C=xs(j,G),S=Math.abs(C)>2e-4?C*Wr:0,x=q?1/(q<0?-q:q):0),n.svg&&(K=e.getAttribute("transform"),n.forceCSS=e.setAttribute("transform","")||!Mm(ui(e,Dt)),K&&e.setAttribute("transform",K))),Math.abs(S)>90&&Math.abs(S)<270&&(r?(d*=-1,S+=g<=0?180:-180,g+=g<=0?180:-180):(_*=-1,S+=S<=0?180:-180)),t=t||n.uncache,n.x=u-((n.xPercent=u&&(!t&&n.xPercent||(Math.round(e.offsetWidth/2)===Math.round(-u)?-50:0)))?e.offsetWidth*n.xPercent/100:0)+a,n.y=h-((n.yPercent=h&&(!t&&n.yPercent||(Math.round(e.offsetHeight/2)===Math.round(-h)?-50:0)))?e.offsetHeight*n.yPercent/100:0)+a,n.z=f+a,n.scaleX=Ot(d),n.scaleY=Ot(_),n.rotation=Ot(g)+o,n.rotationX=Ot(p)+o,n.rotationY=Ot(m)+o,n.skewX=S+o,n.skewY=M+o,n.transformPerspective=x+a,(n.zOrigin=parseFloat(c.split(" ")[2])||!t&&n.zOrigin||0)&&(i[Fn]=Wl(c)),n.xOffset=n.yOffset=0,n.force3D=Zn.force3D,n.renderTransform=n.svg?Zg:xm?Tm:$g,n.uncache=0,n},Wl=function(e){return(e=e.split(" "))[0]+" "+e[1]},xc=function(e,t,n){var i=hn(t);return Ot(parseFloat(t)+parseFloat(Pr(e,"x",n+"px",i)))+i},$g=function(e,t){t.z="0px",t.rotationY=t.rotationX="0deg",t.force3D=0,Tm(e,t)},Nr="0deg",Ta="0px",Fr=") ",Tm=function(e,t){var n=t||this,i=n.xPercent,r=n.yPercent,a=n.x,o=n.y,l=n.z,c=n.rotation,u=n.rotationY,h=n.rotationX,f=n.skewX,d=n.skewY,_=n.scaleX,g=n.scaleY,p=n.transformPerspective,m=n.force3D,S=n.target,M=n.zOrigin,x="",w=m==="auto"&&e&&e!==1||m===!0;if(M&&(h!==Nr||u!==Nr)){var A=parseFloat(u)*$s,b=Math.sin(A),C=Math.cos(A),y;A=parseFloat(h)*$s,y=Math.cos(A),a=xc(S,a,b*y*-M),o=xc(S,o,-Math.sin(A)*-M),l=xc(S,l,C*y*-M+M)}p!==Ta&&(x+="perspective("+p+Fr),(i||r)&&(x+="translate("+i+"%, "+r+"%) "),(w||a!==Ta||o!==Ta||l!==Ta)&&(x+=l!==Ta||w?"translate3d("+a+", "+o+", "+l+") ":"translate("+a+", "+o+Fr),c!==Nr&&(x+="rotate("+c+Fr),u!==Nr&&(x+="rotateY("+u+Fr),h!==Nr&&(x+="rotateX("+h+Fr),(f!==Nr||d!==Nr)&&(x+="skew("+f+", "+d+Fr),(_!==1||g!==1)&&(x+="scale("+_+", "+g+Fr),S.style[Dt]=x||"translate(0, 0)"},Zg=function(e,t){var n=t||this,i=n.xPercent,r=n.yPercent,a=n.x,o=n.y,l=n.rotation,c=n.skewX,u=n.skewY,h=n.scaleX,f=n.scaleY,d=n.target,_=n.xOrigin,g=n.yOrigin,p=n.xOffset,m=n.yOffset,S=n.forceCSS,M=parseFloat(a),x=parseFloat(o),w,A,b,C,y;l=parseFloat(l),c=parseFloat(c),u=parseFloat(u),u&&(u=parseFloat(u),c+=u,l+=u),l||c?(l*=$s,c*=$s,w=Math.cos(l)*h,A=Math.sin(l)*h,b=Math.sin(l-c)*-f,C=Math.cos(l-c)*f,c&&(u*=$s,y=Math.tan(c-u),y=Math.sqrt(1+y*y),b*=y,C*=y,u&&(y=Math.tan(u),y=Math.sqrt(1+y*y),w*=y,A*=y)),w=Ot(w),A=Ot(A),b=Ot(b),C=Ot(C)):(w=h,C=f,A=b=0),(M&&!~(a+"").indexOf("px")||x&&!~(o+"").indexOf("px"))&&(M=Pr(d,"x",a,"px"),x=Pr(d,"y",o,"px")),(_||g||p||m)&&(M=Ot(M+_-(_*w+g*b)+p),x=Ot(x+g-(_*A+g*C)+m)),(i||r)&&(y=d.getBBox(),M=Ot(M+i/100*y.width),x=Ot(x+r/100*y.height)),y="matrix("+w+","+A+","+b+","+C+","+M+","+x+")",d.setAttribute("transform",y),S&&(d.style[Dt]=y)},Jg=function(e,t,n,i,r){var a=360,o=tn(r),l=parseFloat(r)*(o&&~r.indexOf("rad")?Wr:1),c=l-i,u=i+c+"deg",h,f;return o&&(h=r.split("_")[1],h==="short"&&(c%=a,c!==c%(a/2)&&(c+=c<0?a:-360)),h==="cw"&&c<0?c=(c+a*If)%a-~~(c/a)*a:h==="ccw"&&c>0&&(c=(c-a*If)%a-~~(c/a)*a)),e._pt=f=new Nn(e._pt,t,n,i,c,Ng),f.e=u,f.u="deg",e._props.push(n),f},Bf=function(e,t){for(var n in t)e[n]=t[n];return e},Qg=function(e,t,n){var i=Bf({},n._gsap),r="perspective,force3D,transformOrigin,svgOrigin",a=n.style,o,l,c,u,h,f,d,_;i.svg?(c=n.getAttribute("transform"),n.setAttribute("transform",""),a[Dt]=t,o=_o(n,1),ls(n,Dt),n.setAttribute("transform",c)):(c=getComputedStyle(n)[Dt],a[Dt]=t,o=_o(n,1),a[Dt]=c);for(l in sr)c=i[l],u=o[l],c!==u&&r.indexOf(l)<0&&(d=hn(c),_=hn(u),h=d!==_?Pr(n,l,c,_):parseFloat(c),f=parseFloat(u),e._pt=new Nn(e._pt,o,l,h,f-h,Su),e._pt.u=_||0,e._props.push(l));Bf(o,i)};Un("padding,margin,Width,Radius",function(s,e){var t="Top",n="Right",i="Bottom",r="Left",a=(e<3?[t,n,i,r]:[t+r,t+n,i+n,i+r]).map(function(o){return e<2?s+o:"border"+o+s});Gl[e>1?"border"+s:s]=function(o,l,c,u,h){var f,d;if(arguments.length<4)return f=a.map(function(_){return $i(o,_,c)}),d=f.join(" "),d.split(f[0]).length===5?f[0]:d;f=(u+"").split(" "),d={},a.forEach(function(_,g){return d[_]=f[g]=f[g]||f[(g-1)/2|0]}),o.init(l,d,h)}});var Em={name:"css",register:Tu,targetTest:function(e){return e.style&&e.nodeType},init:function(e,t,n,i,r){var a=this._props,o=e.style,l=n.vars.startAt,c,u,h,f,d,_,g,p,m,S,M,x,w,A,b,C;zh||Tu(),this.styles=this.styles||gm(e),C=this.styles.props,this.tween=n;for(g in t)if(g!=="autoRound"&&(u=t[g],!(Xn[g]&&am(g,t,n,i,e,r)))){if(d=typeof u,_=Gl[g],d==="function"&&(u=u.call(n,i,e,r),d=typeof u),d==="string"&&~u.indexOf("random(")&&(u=ho(u)),_)_(this,e,g,u,n)&&(b=1);else if(g.substr(0,2)==="--")c=(getComputedStyle(e).getPropertyValue(g)+"").trim(),u+="",br.lastIndex=0,br.test(c)||(p=hn(c),m=hn(u)),m?p!==m&&(c=Pr(e,g,c,m)+m):p&&(u+=p),this.add(o,"setProperty",c,u,i,r,0,0,g),a.push(g),C.push(g,0,o[g]);else if(d!=="undefined"){if(l&&g in l?(c=typeof l[g]=="function"?l[g].call(n,i,e,r):l[g],tn(c)&&~c.indexOf("random(")&&(c=ho(c)),hn(c+"")||c==="auto"||(c+=Zn.units[g]||hn($i(e,g))||""),(c+"").charAt(1)==="="&&(c=$i(e,g))):c=$i(e,g),f=parseFloat(c),S=d==="string"&&u.charAt(1)==="="&&u.substr(0,2),S&&(u=u.substr(2)),h=parseFloat(u),g in Ii&&(g==="autoAlpha"&&(f===1&&$i(e,"visibility")==="hidden"&&h&&(f=0),C.push("visibility",0,o.visibility),yr(this,o,"visibility",f?"inherit":"hidden",h?"inherit":"hidden",!h)),g!=="scale"&&g!=="transform"&&(g=Ii[g],~g.indexOf(",")&&(g=g.split(",")[0]))),M=g in sr,M){if(this.styles.save(g),d==="string"&&u.substring(0,6)==="var(--"&&(u=ui(e,u.substring(4,u.indexOf(")"))),h=parseFloat(u)),x||(w=e._gsap,w.renderTransform&&!t.parseTransform||_o(e,t.parseTransform),A=t.smoothOrigin!==!1&&w.smooth,x=this._pt=new Nn(this._pt,o,Dt,0,1,w.renderTransform,w,0,-1),x.dep=1),g==="scale")this._pt=new Nn(this._pt,w,"scaleY",w.scaleY,(S?Ks(w.scaleY,S+h):h)-w.scaleY||0,Su),this._pt.u=0,a.push("scaleY",g),g+="X";else if(g==="transformOrigin"){C.push(Fn,0,o[Fn]),u=Kg(u),w.svg?Eu(e,u,0,A,0,this):(m=parseFloat(u.split(" ")[2])||0,m!==w.zOrigin&&yr(this,w,"zOrigin",w.zOrigin,m),yr(this,o,g,Wl(c),Wl(u)));continue}else if(g==="svgOrigin"){Eu(e,u,1,A,0,this);continue}else if(g in Sm){Jg(this,w,g,f,S?Ks(f,S+u):u);continue}else if(g==="smoothOrigin"){yr(this,w,"smooth",w.smooth,u);continue}else if(g==="force3D"){w[g]=u;continue}else if(g==="transform"){Qg(this,u,e);continue}}else g in o||(g=la(g)||g);if(M||(h||h===0)&&(f||f===0)&&!Ug.test(u)&&g in o)p=(c+"").substr((f+"").length),h||(h=0),m=hn(u)||(g in Zn.units?Zn.units[g]:p),p!==m&&(f=Pr(e,g,c,m)),this._pt=new Nn(this._pt,M?w:o,g,f,(S?Ks(f,S+h):h)-f,!M&&(m==="px"||g==="zIndex")&&t.autoRound!==!1?Og:Su),this._pt.u=m||0,p!==m&&m!=="%"&&(this._pt.b=c,this._pt.r=Fg);else if(g in o)qg.call(this,e,g,c,S?S+u:u);else if(g in e)this.add(e,g,c||e[g],S?S+u:u,i,r);else if(g!=="parseTransform"){Ph(g,u);continue}M||(g in o?C.push(g,0,o[g]):typeof e[g]=="function"?C.push(g,2,e[g]()):C.push(g,1,c||e[g])),a.push(g)}}b&&fm(this)},render:function(e,t){if(t.tween._time||!Vh())for(var n=t._pt;n;)n.r(e,n.d),n=n._next;else t.styles.revert()},get:$i,aliases:Ii,getSetter:function(e,t,n){var i=Ii[t];return i&&i.indexOf(",")<0&&(t=i),t in sr&&t!==Fn&&(e._gsap.x||$i(e,"x"))?n&&Pf===n?t==="scale"?Vg:zg:(Pf=n||{})&&(t==="scale"?Hg:Gg):e.style&&!wh(e.style[t])?Bg:~t.indexOf("-")?kg:Bh(e,t)},core:{_removeProperty:ls,_getMatrix:Gh}};Bn.utils.checkPrefix=la;Bn.core.getStyleSaver=gm;(function(s,e,t,n){var i=Un(s+","+e+","+t,function(r){sr[r]=1});Un(e,function(r){Zn.units[r]="deg",Sm[r]=1}),Ii[i[13]]=s+","+e,Un(n,function(r){var a=r.split(":");Ii[a[1]]=i[a[0]]})})("x,y,z,scale,scaleX,scaleY,xPercent,yPercent","rotation,rotationX,rotationY,skewX,skewY","transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective","0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY");Un("x,y,z,top,right,bottom,left,width,height,fontSize,padding,margin,perspective",function(s){Zn.units[s]="px"});Bn.registerPlugin(Em);var bm=Bn.registerPlugin(Em)||Bn;bm.core.Tween;function e0(s,e){for(var t=0;t<e.length;t++){var n=e[t];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(s,n.key,n)}}function t0(s,e,t){return e&&e0(s.prototype,e),s}/*!
 * Observer 3.13.0
 * https://gsap.com
 *
 * @license Copyright 2008-2025, GreenSock. All rights reserved.
 * Subject to the terms at https://gsap.com/standard-license
 * @author: Jack Doyle, jack@greensock.com
*/var sn,El,Kn,Sr,Mr,Zs,Am,Xr,Za,wm,Qi,xi,Rm,Cm=function(){return sn||typeof window<"u"&&(sn=window.gsap)&&sn.registerPlugin&&sn},Pm=1,Ws=[],it=[],Fi=[],Ja=Date.now,bu=function(e,t){return t},n0=function(){var e=Za.core,t=e.bridge||{},n=e._scrollers,i=e._proxies;n.push.apply(n,it),i.push.apply(i,Fi),it=n,Fi=i,bu=function(a,o){return t[a](o)}},Ar=function(e,t){return~Fi.indexOf(e)&&Fi[Fi.indexOf(e)+1][t]},Qa=function(e){return!!~wm.indexOf(e)},yn=function(e,t,n,i,r){return e.addEventListener(t,n,{passive:i!==!1,capture:!!r})},xn=function(e,t,n,i){return e.removeEventListener(t,n,!!i)},Lo="scrollLeft",Uo="scrollTop",Au=function(){return Qi&&Qi.isPressed||it.cache++},Xl=function(e,t){var n=function i(r){if(r||r===0){Pm&&(Kn.history.scrollRestoration="manual");var a=Qi&&Qi.isPressed;r=i.v=Math.round(r)||(Qi&&Qi.iOS?1:0),e(r),i.cacheID=it.cache,a&&bu("ss",r)}else(t||it.cache!==i.cacheID||bu("ref"))&&(i.cacheID=it.cache,i.v=e());return i.v+i.offset};return n.offset=0,e&&n},An={s:Lo,p:"left",p2:"Left",os:"right",os2:"Right",d:"width",d2:"Width",a:"x",sc:Xl(function(s){return arguments.length?Kn.scrollTo(s,Kt.sc()):Kn.pageXOffset||Sr[Lo]||Mr[Lo]||Zs[Lo]||0})},Kt={s:Uo,p:"top",p2:"Top",os:"bottom",os2:"Bottom",d:"height",d2:"Height",a:"y",op:An,sc:Xl(function(s){return arguments.length?Kn.scrollTo(An.sc(),s):Kn.pageYOffset||Sr[Uo]||Mr[Uo]||Zs[Uo]||0})},In=function(e,t){return(t&&t._ctx&&t._ctx.selector||sn.utils.toArray)(e)[0]||(typeof e=="string"&&sn.config().nullTargetWarn!==!1?console.warn("Element not found:",e):null)},i0=function(e,t){for(var n=t.length;n--;)if(t[n]===e||t[n].contains(e))return!0;return!1},Ir=function(e,t){var n=t.s,i=t.sc;Qa(e)&&(e=Sr.scrollingElement||Mr);var r=it.indexOf(e),a=i===Kt.sc?1:2;!~r&&(r=it.push(e)-1),it[r+a]||yn(e,"scroll",Au);var o=it[r+a],l=o||(it[r+a]=Xl(Ar(e,n),!0)||(Qa(e)?i:Xl(function(c){return arguments.length?e[n]=c:e[n]})));return l.target=e,o||(l.smooth=sn.getProperty(e,"scrollBehavior")==="smooth"),l},wu=function(e,t,n){var i=e,r=e,a=Ja(),o=a,l=t||50,c=Math.max(500,l*3),u=function(_,g){var p=Ja();g||p-a>l?(r=i,i=_,o=a,a=p):n?i+=_:i=r+(_-r)/(p-o)*(a-o)},h=function(){r=i=n?0:i,o=a=0},f=function(_){var g=o,p=r,m=Ja();return(_||_===0)&&_!==i&&u(_),a===o||m-o>c?0:(i+(n?p:-p))/((n?m:a)-g)*1e3};return{update:u,reset:h,getVelocity:f}},Ea=function(e,t){return t&&!e._gsapAllow&&e.preventDefault(),e.changedTouches?e.changedTouches[0]:e},kf=function(e){var t=Math.max.apply(Math,e),n=Math.min.apply(Math,e);return Math.abs(t)>=Math.abs(n)?t:n},Im=function(){Za=sn.core.globals().ScrollTrigger,Za&&Za.core&&n0()},Dm=function(e){return sn=e||Cm(),!El&&sn&&typeof document<"u"&&document.body&&(Kn=window,Sr=document,Mr=Sr.documentElement,Zs=Sr.body,wm=[Kn,Sr,Mr,Zs],sn.utils.clamp,Rm=sn.core.context||function(){},Xr="onpointerenter"in Zs?"pointer":"mouse",Am=Bt.isTouch=Kn.matchMedia&&Kn.matchMedia("(hover: none), (pointer: coarse)").matches?1:"ontouchstart"in Kn||navigator.maxTouchPoints>0||navigator.msMaxTouchPoints>0?2:0,xi=Bt.eventTypes=("ontouchstart"in Mr?"touchstart,touchmove,touchcancel,touchend":"onpointerdown"in Mr?"pointerdown,pointermove,pointercancel,pointerup":"mousedown,mousemove,mouseup,mouseup").split(","),setTimeout(function(){return Pm=0},500),Im(),El=1),El};An.op=Kt;it.cache=0;var Bt=function(){function s(t){this.init(t)}var e=s.prototype;return e.init=function(n){El||Dm(sn)||console.warn("Please gsap.registerPlugin(Observer)"),Za||Im();var i=n.tolerance,r=n.dragMinimum,a=n.type,o=n.target,l=n.lineHeight,c=n.debounce,u=n.preventDefault,h=n.onStop,f=n.onStopDelay,d=n.ignore,_=n.wheelSpeed,g=n.event,p=n.onDragStart,m=n.onDragEnd,S=n.onDrag,M=n.onPress,x=n.onRelease,w=n.onRight,A=n.onLeft,b=n.onUp,C=n.onDown,y=n.onChangeX,v=n.onChangeY,P=n.onChange,N=n.onToggleX,B=n.onToggleY,W=n.onHover,j=n.onHoverEnd,G=n.onMove,K=n.ignoreCheck,V=n.isNormalizer,te=n.onGestureStart,I=n.onGestureEnd,le=n.onWheel,De=n.onEnable,Je=n.onDisable,q=n.onClick,ne=n.scrollSpeed,de=n.capture,ie=n.allowClicks,Ee=n.lockAxis,Oe=n.onLockAxis;this.target=o=In(o)||Mr,this.vars=n,d&&(d=sn.utils.toArray(d)),i=i||1e-9,r=r||0,_=_||1,ne=ne||1,a=a||"wheel,touch,pointer",c=c!==!1,l||(l=parseFloat(Kn.getComputedStyle(Zs).lineHeight)||22);var Pe,st,et,ye,D,St,ke,k=this,Me=0,ot=0,be=n.passive||!u&&n.passive!==!1,R=Ir(o,An),T=Ir(o,Kt),z=R(),Q=T(),J=~a.indexOf("touch")&&!~a.indexOf("pointer")&&xi[0]==="pointerdown",$=Qa(o),he=o.ownerDocument||Sr,ae=[0,0,0],fe=[0,0,0],We=0,re=function(){return We=Ja()},se=function(Ae,Ke){return(k.event=Ae)&&d&&i0(Ae.target,d)||Ke&&J&&Ae.pointerType!=="touch"||K&&K(Ae,Ke)},Le=function(){k._vx.reset(),k._vy.reset(),st.pause(),h&&h(k)},Ie=function(){var Ae=k.deltaX=kf(ae),Ke=k.deltaY=kf(fe),pe=Math.abs(Ae)>=i,Ve=Math.abs(Ke)>=i;P&&(pe||Ve)&&P(k,Ae,Ke,ae,fe),pe&&(w&&k.deltaX>0&&w(k),A&&k.deltaX<0&&A(k),y&&y(k),N&&k.deltaX<0!=Me<0&&N(k),Me=k.deltaX,ae[0]=ae[1]=ae[2]=0),Ve&&(C&&k.deltaY>0&&C(k),b&&k.deltaY<0&&b(k),v&&v(k),B&&k.deltaY<0!=ot<0&&B(k),ot=k.deltaY,fe[0]=fe[1]=fe[2]=0),(ye||et)&&(G&&G(k),et&&(p&&et===1&&p(k),S&&S(k),et=0),ye=!1),St&&!(St=!1)&&Oe&&Oe(k),D&&(le(k),D=!1),Pe=0},xe=function(Ae,Ke,pe){ae[pe]+=Ae,fe[pe]+=Ke,k._vx.update(Ae),k._vy.update(Ke),c?Pe||(Pe=requestAnimationFrame(Ie)):Ie()},qe=function(Ae,Ke){Ee&&!ke&&(k.axis=ke=Math.abs(Ae)>Math.abs(Ke)?"x":"y",St=!0),ke!=="y"&&(ae[2]+=Ae,k._vx.update(Ae,!0)),ke!=="x"&&(fe[2]+=Ke,k._vy.update(Ke,!0)),c?Pe||(Pe=requestAnimationFrame(Ie)):Ie()},Fe=function(Ae){if(!se(Ae,1)){Ae=Ea(Ae,u);var Ke=Ae.clientX,pe=Ae.clientY,Ve=Ke-k.x,we=pe-k.y,ze=k.isDragging;k.x=Ke,k.y=pe,(ze||(Ve||we)&&(Math.abs(k.startX-Ke)>=r||Math.abs(k.startY-pe)>=r))&&(et=ze?2:1,ze||(k.isDragging=!0),qe(Ve,we))}},ct=k.onPress=function(ge){se(ge,1)||ge&&ge.button||(k.axis=ke=null,st.pause(),k.isPressed=!0,ge=Ea(ge),Me=ot=0,k.startX=k.x=ge.clientX,k.startY=k.y=ge.clientY,k._vx.reset(),k._vy.reset(),yn(V?o:he,xi[1],Fe,be,!0),k.deltaX=k.deltaY=0,M&&M(k))},L=k.onRelease=function(ge){if(!se(ge,1)){xn(V?o:he,xi[1],Fe,!0);var Ae=!isNaN(k.y-k.startY),Ke=k.isDragging,pe=Ke&&(Math.abs(k.x-k.startX)>3||Math.abs(k.y-k.startY)>3),Ve=Ea(ge);!pe&&Ae&&(k._vx.reset(),k._vy.reset(),u&&ie&&sn.delayedCall(.08,function(){if(Ja()-We>300&&!ge.defaultPrevented){if(ge.target.click)ge.target.click();else if(he.createEvent){var we=he.createEvent("MouseEvents");we.initMouseEvent("click",!0,!0,Kn,1,Ve.screenX,Ve.screenY,Ve.clientX,Ve.clientY,!1,!1,!1,!1,0,null),ge.target.dispatchEvent(we)}}})),k.isDragging=k.isGesturing=k.isPressed=!1,h&&Ke&&!V&&st.restart(!0),et&&Ie(),m&&Ke&&m(k),x&&x(k,pe)}},ce=function(Ae){return Ae.touches&&Ae.touches.length>1&&(k.isGesturing=!0)&&te(Ae,k.isDragging)},Y=function(){return(k.isGesturing=!1)||I(k)},Z=function(Ae){if(!se(Ae)){var Ke=R(),pe=T();xe((Ke-z)*ne,(pe-Q)*ne,1),z=Ke,Q=pe,h&&st.restart(!0)}},oe=function(Ae){if(!se(Ae)){Ae=Ea(Ae,u),le&&(D=!0);var Ke=(Ae.deltaMode===1?l:Ae.deltaMode===2?Kn.innerHeight:1)*_;xe(Ae.deltaX*Ke,Ae.deltaY*Ke,0),h&&!V&&st.restart(!0)}},ue=function(Ae){if(!se(Ae)){var Ke=Ae.clientX,pe=Ae.clientY,Ve=Ke-k.x,we=pe-k.y;k.x=Ke,k.y=pe,ye=!0,h&&st.restart(!0),(Ve||we)&&qe(Ve,we)}},Be=function(Ae){k.event=Ae,W(k)},ht=function(Ae){k.event=Ae,j(k)},Lt=function(Ae){return se(Ae)||Ea(Ae,u)&&q(k)};st=k._dc=sn.delayedCall(f||.25,Le).pause(),k.deltaX=k.deltaY=0,k._vx=wu(0,50,!0),k._vy=wu(0,50,!0),k.scrollX=R,k.scrollY=T,k.isDragging=k.isGesturing=k.isPressed=!1,Rm(this),k.enable=function(ge){return k.isEnabled||(yn($?he:o,"scroll",Au),a.indexOf("scroll")>=0&&yn($?he:o,"scroll",Z,be,de),a.indexOf("wheel")>=0&&yn(o,"wheel",oe,be,de),(a.indexOf("touch")>=0&&Am||a.indexOf("pointer")>=0)&&(yn(o,xi[0],ct,be,de),yn(he,xi[2],L),yn(he,xi[3],L),ie&&yn(o,"click",re,!0,!0),q&&yn(o,"click",Lt),te&&yn(he,"gesturestart",ce),I&&yn(he,"gestureend",Y),W&&yn(o,Xr+"enter",Be),j&&yn(o,Xr+"leave",ht),G&&yn(o,Xr+"move",ue)),k.isEnabled=!0,k.isDragging=k.isGesturing=k.isPressed=ye=et=!1,k._vx.reset(),k._vy.reset(),z=R(),Q=T(),ge&&ge.type&&ct(ge),De&&De(k)),k},k.disable=function(){k.isEnabled&&(Ws.filter(function(ge){return ge!==k&&Qa(ge.target)}).length||xn($?he:o,"scroll",Au),k.isPressed&&(k._vx.reset(),k._vy.reset(),xn(V?o:he,xi[1],Fe,!0)),xn($?he:o,"scroll",Z,de),xn(o,"wheel",oe,de),xn(o,xi[0],ct,de),xn(he,xi[2],L),xn(he,xi[3],L),xn(o,"click",re,!0),xn(o,"click",Lt),xn(he,"gesturestart",ce),xn(he,"gestureend",Y),xn(o,Xr+"enter",Be),xn(o,Xr+"leave",ht),xn(o,Xr+"move",ue),k.isEnabled=k.isPressed=k.isDragging=!1,Je&&Je(k))},k.kill=k.revert=function(){k.disable();var ge=Ws.indexOf(k);ge>=0&&Ws.splice(ge,1),Qi===k&&(Qi=0)},Ws.push(k),V&&Qa(o)&&(Qi=k),k.enable(g)},t0(s,[{key:"velocityX",get:function(){return this._vx.getVelocity()}},{key:"velocityY",get:function(){return this._vy.getVelocity()}}]),s}();Bt.version="3.13.0";Bt.create=function(s){return new Bt(s)};Bt.register=Dm;Bt.getAll=function(){return Ws.slice()};Bt.getById=function(s){return Ws.filter(function(e){return e.vars.id===s})[0]};Cm()&&sn.registerPlugin(Bt);/*!
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:wr,depthTest:!1,depthWrite:!1})}function np(){return new Dr({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:yf(),fragmentShader:`
		...
		`,blending:wr,depthTest:!1,depthWrite:!1})}function ip(){return new Dr({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:yf(),fragmentShader:`
...
`:"";t.isRawShaderMaterial?(p=["#define SHADER_TYPE "+t.shaderType,"#define SHADER_NAME "+t.shaderName,_].filter(qa).join(`
`),p.length>0&&(p+=`
`),m=["#define SHADER_TYPE "+t.shaderType,"#define SHADER_NAME "+t.shaderName,_].filter(qa).join(`
`),m.length>0&&(m+=`
