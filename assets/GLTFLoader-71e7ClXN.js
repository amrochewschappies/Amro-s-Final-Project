 ...
 * Subject to the terms at https://gsap.com/standard-license
 * @author: Jack Doyle, jack@greensock.com
*/var sn,El,jn,Sr,Mr,Zs,Am,Xr,Za,wm,Qi,xi,Rm,Cm=function(){return sn||typeof window<"u"&&(sn=window.gsap)&&sn.registerPlugin&&sn},Pm=1,Ws=[],it=[],Fi=[],Ja=Date.now,bu=function(e,t){return t},n0=function(){var e=Za.core,t=e.bridge||{},n=e._scrollers,i=e._proxies;n.push.apply(n,it),i.push.apply(i,Fi),it=n,Fi=i,bu=function(a,o){return t[a](o)}},Ar=function(e,t){return~Fi.indexOf(e)&&Fi[Fi.indexOf(e)+1][t]},Qa=function(e){return!!~wm.indexOf(e)},yn=function(e,t,n,i,r){return e.addEventListener(t,n,{passive:i!==!1,capture:!!r})},xn=function(e,t,n,i){return e.removeEventListener(t,n,!!i)},Do="scrollLeft",Uo="scrollTop",Au=function(){return Qi&&Qi.isPressed||it.cache++},Xl=function(e,t){var n=function i(r){if(r||r===0){Pm&&(jn.history.scrollRestoration="manual");var a=Qi&&Qi.isPressed;r=i.v=Math.round(r)||(Qi&&Qi.iOS?1:0),e(r),i.cacheID=it.cache,a&&bu("ss",r)}else(t||it.cache!==i.cacheID||bu("ref"))&&(i.cacheID=it.cache,i.v=e());return i.v+i.offset};return n.offset=0,e&&n},An={s:Do,p:"left",p2:"Left",os:"right",os2:"Right",d:"width",d2:"Width",a:"x",sc:Xl(function(s){return arguments.length?jn.scrollTo(s,jt.sc()):jn.pageXOffset||Sr[Do]||Mr[Do]||Zs[Do]||0})},jt={s:Uo,p:"top",p2:"Top",os:"bottom",os2:"Bottom",d:"height",d2:"Height",a:"y",op:An,sc:Xl(function(s){return arguments.length?jn.scrollTo(An.sc(),s):jn.pageYOffset||Sr[Uo]||Mr[Uo]||Zs[Uo]||0})},In=function(e,t){return(t&&t._ctx&&t._ctx.selector||sn.utils.toArray)(e)[0]||(typeof e=="string"&&sn.config().nullTargetWarn!==!1?console.warn("Element not found:",e):null)},i0=function(e,t){for(var n=t.length;n--;)if(t[n]===e||t[n].contains(e))return!0;return!1},Ir=function(e,t){var n=t.s,i=t.sc;Qa(e)&&(e=Sr.scrollingElement||Mr);var r=it.indexOf(e),a=i===jt.sc?1:2;!~r&&(r=it.push(e)-1),it[r+a]||yn(e,"scroll",Au);var o=it[r+a],l=o||(it[r+a]=Xl(Ar(e,n),!0)||(Qa(e)?i:Xl(function(c){return arguments.length?e[n]=c:e[n]})));return l.target=e,o||(l.smooth=sn.getProperty(e,"scrollBehavior")==="smooth"),l},wu=function(e,t,n){var i=e,r=e,a=Ja(),o=a,l=t||50,c=Math.max(500,l*3),u=function(_,g){var m=Ja();g||m-a>l?(r=i,i=_,o=a,a=m):n?i+=_:i=r+(_-r)/(m-o)*(a-o)},h=function(){r=i=n?0:i,o=a=0},f=function(_){var g=o,m=r,p=Ja();return(_||_===0)&&_!==i&&u(_),a===o||p-o>c?0:(i+(n?m:-m))/((n?p:a)-g)*1e3};return{update:u,reset:h,getVelocity:f}},Ea=function(e,t){return t&&!e._gsapAllow&&e.preventDefault(),e.changedTouches?e.changedTouches[0]:e},kf=function(e){var t=Math.max.apply(Math,e),n=Math.min.apply(Math,e);return Math.abs(t)>=Math.abs(n)?t:n},Im=function(){Za=sn.core.globals().ScrollTrigger,Za&&Za.core&&n0()},Lm=function(e){return sn=e||Cm(),!El&&sn&&typeof document<"u"&&document.body&&(jn=window,Sr=document,Mr=Sr.documentElement,Zs=Sr.body,wm=[jn,Sr,Mr,Zs],sn.utils.clamp,Rm=sn.core.context||function(){},Xr="onpointerenter"in Zs?"pointer":"mouse",Am=Bt.isTouch=jn.matchMedia&&jn.matchMedia("(hover: none), (pointer: coarse)").matches?1:"ontouchstart"in jn||navigator.maxTouchPoints>0||navigator.msMaxTouchPoints>0?2:0,xi=Bt.eventTypes=("ontouchstart"in Mr?"touchstart,touchmove,touchcancel,touchend":"onpointerdown"in Mr?"pointerdown,pointermove,pointercancel,pointerup":"mousedown,mousemove,mouseup,mouseup").split(","),setTimeout(function(){return Pm=0},500),Im(),El=1),El};An.op=jt;it.cache=0;var Bt=function(){function s(t){this.init(t)}var e=s.prototype;return e.init=function(n){El||Lm(sn)||console.warn("Please gsap.registerPlugin(Observer)"),Za||Im();var i=n.tolerance,r=n.dragMinimum,a=n.type,o=n.target,l=n.lineHeight,c=n.debounce,u=n.preventDefault,h=n.onStop,f=n.onStopDelay,d=n.ignore,_=n.wheelSpeed,g=n.event,m=n.onDragStart,p=n.onDragEnd,S=n.onDrag,M=n.onPress,x=n.onRelease,w=n.onRight,A=n.onLeft,b=n.onUp,C=n.onDown,y=n.onChangeX,v=n.onChangeY,P=n.onChange,N=n.onToggleX,B=n.onToggleY,W=n.onHover,K=n.onHoverEnd,G=n.onMove,j=n.ignoreCheck,V=n.isNormalizer,te=n.onGestureStart,I=n.onGestureEnd,le=n.onWheel,Le=n.onEnable,Je=n.onDisable,q=n.onClick,ne=n.scrollSpeed,de=n.capture,ie=n.allowClicks,Ee=n.lockAxis,Oe=n.onLockAxis;this.target=o=In(o)||Mr,this.vars=n,d&&(d=sn.utils.toArray(d)),i=i||1e-9,r=r||0,_=_||1,ne=ne||1,a=a||"wheel,touch,pointer",c=c!==!1,l||(l=parseFloat(jn.getComputedStyle(Zs).lineHeight)||22);var Pe,st,et,ye,L,St,ke,k=this,Me=0,ot=0,be=n.passive||!u&&n.passive!==!1,R=Ir(o,An),T=Ir(o,jt),z=R(),Q=T(),J=~a.indexOf("touch")&&!~a.indexOf("pointer")&&xi[0]==="pointerdown",$=Qa(o),he=o.ownerDocument||Sr,ae=[0,0,0],fe=[0,0,0],We=0,re=function(){return We=Ja()},se=function(Ae,je){return(k.event=Ae)&&d&&i0(Ae.target,d)||je&&J&&Ae.pointerType!=="touch"||j&&j(Ae,je)},De=function(){k._vx.reset(),k._vy.reset(),st.pause(),h&&h(k)},Ie=function(){var Ae=k.deltaX=kf(ae),je=k.deltaY=kf(fe),pe=Math.abs(Ae)>=i,Ve=Math.abs(je)>=i;P&&(pe||Ve)&&P(k,Ae,je,ae,fe),pe&&(w&&k.deltaX>0&&w(k),A&&k.deltaX<0&&A(k),y&&y(k),N&&k.deltaX<0!=Me<0&&N(k),Me=k.deltaX,ae[0]=ae[1]=ae[2]=0),Ve&&(C&&k.deltaY>0&&C(k),b&&k.deltaY<0&&b(k),v&&v(k),B&&k.deltaY<0!=ot<0&&B(k),ot=k.deltaY,fe[0]=fe[1]=fe[2]=0),(ye||et)&&(G&&G(k),et&&(m&&et===1&&m(k),S&&S(k),et=0),ye=!1),St&&!(St=!1)&&Oe&&Oe(k),L&&(le(k),L=!1),Pe=0},xe=function(Ae,je,pe){ae[pe]+=Ae,fe[pe]+=je,k._vx.update(Ae),k._vy.update(je),c?Pe||(Pe=requestAnimationFrame(Ie)):Ie()},qe=function(Ae,je){Ee&&!ke&&(k.axis=ke=Math.abs(Ae)>Math.abs(je)?"x":"y",St=!0),ke!=="y"&&(ae[2]+=Ae,k._vx.update(Ae,!0)),ke!=="x"&&(fe[2]+=je,k._vy.update(je,!0)),c?Pe||(Pe=requestAnimationFrame(Ie)):Ie()},Fe=function(Ae){if(!se(Ae,1)){Ae=Ea(Ae,u);var je=Ae.clientX,pe=Ae.clientY,Ve=je-k.x,we=pe-k.y,ze=k.isDragging;k.x=je,k.y=pe,(ze||(Ve||we)&&(Math.abs(k.startX-je)>=r||Math.abs(k.startY-pe)>=r))&&(et=ze?2:1,ze||(k.isDragging=!0),qe(Ve,we))}},ct=k.onPress=function(ge){se(ge,1)||ge&&ge.button||(k.axis=ke=null,st.pause(),k.isPressed=!0,ge=Ea(ge),Me=ot=0,k.startX=k.x=ge.clientX,k.startY=k.y=ge.clientY,k._vx.reset(),k._vy.reset(),yn(V?o:he,xi[1],Fe,be,!0),k.deltaX=k.deltaY=0,M&&M(k))},D=k.onRelease=function(ge){if(!se(ge,1)){xn(V?o:he,xi[1],Fe,!0);var Ae=!isNaN(k.y-k.startY),je=k.isDragging,pe=je&&(Math.abs(k.x-k.startX)>3||Math.abs(k.y-k.startY)>3),Ve=Ea(ge);!pe&&Ae&&(k._vx.reset(),k._vy.reset(),u&&ie&&sn.delayedCall(.08,function(){if(Ja()-We>300&&!ge.defaultPrevented){if(ge.target.click)ge.target.click();else if(he.createEvent){var we=he.createEvent("MouseEvents");we.initMouseEvent("click",!0,!0,jn,1,Ve.screenX,Ve.screenY,Ve.clientX,Ve.clientY,!1,!1,!1,!1,0,null),ge.target.dispatchEvent(we)}}})),k.isDragging=k.isGesturing=k.isPressed=!1,h&&je&&!V&&st.restart(!0),et&&Ie(),p&&je&&p(k),x&&x(k,pe)}},ce=function(Ae){return Ae.touches&&Ae.touches.length>1&&(k.isGesturing=!0)&&te(Ae,k.isDragging)},Y=function(){return(k.isGesturing=!1)||I(k)},Z=function(Ae){if(!se(Ae)){var je=R(),pe=T();xe((je-z)*ne,(pe-Q)*ne,1),z=je,Q=pe,h&&st.restart(!0)}},oe=function(Ae){if(!se(Ae)){Ae=Ea(Ae,u),le&&(L=!0);var je=(Ae.deltaMode===1?l:Ae.deltaMode===2?jn.innerHeight:1)*_;xe(Ae.deltaX*je,Ae.deltaY*je,0),h&&!V&&st.restart(!0)}},ue=function(Ae){if(!se(Ae)){var je=Ae.clientX,pe=Ae.clientY,Ve=je-k.x,we=pe-k.y;k.x=je,k.y=pe,ye=!0,h&&st.restart(!0),(Ve||we)&&qe(Ve,we)}},Be=function(Ae){k.event=Ae,W(k)},ht=function(Ae){k.event=Ae,K(k)},Dt=function(Ae){return se(Ae)||Ea(Ae,u)&&q(k)};st=k._dc=sn.delayedCall(f||.25,De).pause(),k.deltaX=k.deltaY=0,k._vx=wu(0,50,!0),k._vy=wu(0,50,!0),k.scrollX=R,k.scrollY=T,k.isDragging=k.isGesturing=k.isPressed=!1,Rm(this),k.enable=function(ge){return k.isEnabled||(yn($?he:o,"scroll",Au),a.indexOf("scroll")>=0&&yn($?he:o,"scroll",Z,be,de),a.indexOf("wheel")>=0&&yn(o,"wheel",oe,be,de),(a.indexOf("touch")>=0&&Am||a.indexOf("pointer")>=0)&&(yn(o,xi[0],ct,be,de),yn(he,xi[2],D),yn(he,xi[3],D),ie&&yn(o,"click",re,!0,!0),q&&yn(o,"click",Dt),te&&yn(he,"gesturestart",ce),I&&yn(he,"gestureend",Y),W&&yn(o,Xr+"enter",Be),K&&yn(o,Xr+"leave",ht),G&&yn(o,Xr+"move",ue)),k.isEnabled=!0,k.isDragging=k.isGesturing=k.isPressed=ye=et=!1,k._vx.reset(),k._vy.reset(),z=R(),Q=T(),ge&&ge.type&&ct(ge),Le&&Le(k)),k},k.disable=function(){k.isEnabled&&(Ws.filter(function(ge){return ge!==k&&Qa(ge.target)}).length||xn($?he:o,"scroll",Au),k.isPressed&&(k._vx.reset(),k._vy.reset(),xn(V?o:he,xi[1],Fe,!0)),xn($?he:o,"scroll",Z,de),xn(o,"wheel",oe,de),xn(o,xi[0],ct,de),xn(he,xi[2],D),xn(he,xi[3],D),xn(o,"click",re,!0),xn(o,"click",Dt),xn(he,"gesturestart",ce),xn(he,"gestureend",Y),xn(o,Xr+"enter",Be),xn(o,Xr+"leave",ht),xn(o,Xr+"move",ue),k.isEnabled=k.isPressed=k.isDragging=!1,Je&&Je(k))},k.kill=k.revert=function(){k.disable();var ge=Ws.indexOf(k);ge>=0&&Ws.splice(ge,1),Qi===k&&(Qi=0)},Ws.push(k),V&&Qa(o)&&(Qi=k),k.enable(g)},t0(s,[{key:"velocityX",get:function(){return this._vx.getVelocity()}},{key:"velocityY",get:function(){return this._vy.getVelocity()}}]),s}();Bt.version="3.13.0";Bt.create=function(s){return new Bt(s)};Bt.register=Lm;Bt.getAll=function(){return Ws.slice()};Bt.getById=function(s){return Ws.filter(function(e){return e.vars.id===s})[0]};Cm()&&sn.registerPlugin(Bt);/*!
